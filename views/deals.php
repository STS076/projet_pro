...
<body class="m-0 p-0">
    ...
    <main>
        ...
        <div class="row mx-0 p-0 my-5 bg-light text-center">
            ...
            <?php foreach ($getCommentByDeal as $value) { ?>
                <div class="my-2 text-center">
                    <p>Posted on <?= $value['comments_date'] ?> : <?= $value['comments_comment'] ?> </p>
                    <hr size="30">
                </div>
            <?php } ?>
            ...
            <div class="row mx-0 p-0 my-5 bg-light justify-content-center">
                <div class="col-lg-8 col-11 d-flex justify-content-center">
                    <form action="deals.php?choice=<?= $oneDealArray['deals_title'] ?>#reviews" method="post">
