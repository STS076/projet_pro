            ...
            <div class=" col-lg-6 p-5  col-11">
                ...
                <form method="POST" action="">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <input class="form-control" type="text" name="dealTitle" id="dealTitle" value="<?= isset($_POST['dealTitle']) && !empty($_POST['dealTitle']) ? $_POST['dealTitle'] : $oneDealArray['deals_title'] ?>">
                    </div>
                    <div class="d-flex flex-column">
                        ...
                        <textarea class="form-control" type="text" id="dealMiniSummary" name="dealMiniSummary"><?= isset($_POST['dealMiniSummary']) ? $_POST['dealMiniSummary'] : $oneDealArray['deals_mini_summary'] ?></textarea>
                    </div>
                    <div class="d-flex flex-column">
                        ...
                        <textarea class="form-control" type="text" id="dealSummary" name="dealSummary"><?= isset($_POST['dealSummary']) ? $_POST['dealSummary'] : $oneDealArray['deals_summary'] ?></textarea>
                    </div>
                    <div class="d-flex flex-column">
                        ...
                        <input class="form-control" type="text" id="dealWhen" value="<?= isset($_POST['dealWhen']) ? $_POST['dealWhen'] : $oneDealArray['deals_when'] ?>" name="dealWhen">
                    </div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <input class="form-control" type="text" id="dealWhere" value="<?= isset($_POST['dealWhere']) ? $_POST['dealWhere'] : $oneDealArray['deals_where'] ?>" name="dealWhere">
                    </div>
                    <div class="d-flex flex-column">
                        <label class="py-2">
                            Price :
                        ...
                        <input class="form-control" type="text" id="dealPrice" value="<?= isset($_POST['dealPrice']) ? $_POST['dealPrice'] : $oneDealArray['deals_price'] ?>" name="dealPrice">
                    </div>
                    <div class="d-flex flex-column">
                        <label class="py-2">
                            How to get there :
                        ...
                        <input class="form-control" type="text" id="dealMetro" value="<?= isset($_POST['dealMetro']) ? $_POST['dealMetro'] : $oneDealArray['deals_metro'] ?>" name="dealMetro">
                    </div>
                    <div class="d-flex flex-column">
                        <label class="py-2">
                            More info :
                        ...
                        <input class="form-control" type="text" id="dealInfo" value="<?= isset($_POST['dealInfo']) ? $_POST['dealInfo'] : $oneDealArray['deals_info'] ?>" name="dealInfo">
                    </div>
                    <div class="d-flex flex-column">
                        <label class="py-2">
                            Contact :
                        ...
                        <input class="form-control" type="text" id="dealContact" value="<?= isset($_POST['dealContact']) ? $_POST['dealContact'] : $oneDealArray['deals_contact'] ?>" name="dealContact">
                    </div>
                    <div class="d-flex flex-column">
                        <label class="py-2">
                            Map :
                        ...
                        <textarea class="form-control" type="text" id="dealMap" name="dealMap"><?= isset($_POST['dealMap']) ? $_POST['dealMap'] : $oneDealArray['deals_map'] ?></textarea>
                    </div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <select class="form-control" id="dealTagCat" multiple value="<?= $oneDealArray['DealsCatTag'] ?>" name="dealTagCat[]">
